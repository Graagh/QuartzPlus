...
public class BlackQuartz extends Block {
    ...
    /**
     * Returns an item stack containing a single instance of the current block sidetype. 'i' is the block's subsidetype/damage
     * and is ignored for blocks which do not support subsidetypes. Blocks which cannot be harvested should return null.
     */
    ...
    /*private static final String[] blockNames = {
    		"Smoky Quartz Block", "Chiseled Smoky Quartz Block", "Smoky Quartz Pillar"
    };*/
}