...
public class Generation implements IWorldGenerator {
    ...
    /*
     * This gets our configured multiplier for each ore block. This will be
     * multiplied by our chance variable in spawnOre(args) to give more or less
    ...
    /*
     * The actual function that generates/adds the blocks - in the switch, each
     * case corresponds to that dimension number (-1 | Nether, 0 | Overworld, 1
     * | The End, 7 | Twilight Forest (IF the mod is installed, otherwise case 7
     * is ignored). In this case, -1 and 1 don't have anything - this just means
     * none of the quartz will spawn there.
     */
    @Override
    ...
    /*
     * If you look down to the spawnOre function, All these values correspond to
     * those.
     */
    private void generateWorld (World world, Random random, int x, int z) {
        ...
        this.spawnOre(Quartz.smoky_quartz_ore, world, random, x, z, 16, 16, 2 + random.nextInt(6), (int) (20 * smokyMult), 20, smokyMaxY, Blocks.stone);
        this.spawnOre(Quartz.rose_quartz_ore, world, random, x, z, 16, 16, 2 + random.nextInt(6), (int) (20 * roseMult), 20, roseMaxY, Blocks.stone);
    }
    
    /*
     * Each variable should speak for itself. BlockX, BlockZ, maxX, and maxZ we
     * tend not to mess with, this is the horizontal placement within the chunk.
     * minY and maxY are what you would change to define the range in which your
     * block will spawn.
     */
