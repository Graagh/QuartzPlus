...
public class RoseQuartzOre extends OreQP {
    
    private static ConfigHandler config;
    private QuartzPlusBlocks     blocks;
    private Random               random = new Random();
    
    public RoseQuartzOre (Material material) {
        super(material);
        setBlockTextureName("quartz:rose_quartz_ore");
    }
    ...
    public Item getItemDropped (int i, Random rand, int j) {
        return config.dropItem ? Items.quartz : Item.getItemFromBlock(blocks.rose_quartz_ore);
    }
